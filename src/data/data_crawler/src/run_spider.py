...
ARTICLES = 50
INTERVAL = 1.2
OUTPUT = './NLP.2023.1.Generative-Based-Chatbot/data_crawler/data/Diseases'
file_path = './NLP.2023.1.Generative-Based-Chatbot/data_crawler/src/contect_url.txt'
disease_path = './NLP.2023.1.Generative-Based-Chatbot/data_crawler/src/disease.txt'
...
if __name__ == "__main__": 
    ...
    with open(disease_path, 'r') as f:
        ...
        for line in lines:
            ...
            run = 'python ./NLP.2023.1.Generative-Based-Chatbot/data_crawler/src/spider.py {0} --output={1} --articles={2} --interval={3}'.format(url, disease_folder, ARTICLES, INTERVAL)
            os.system(run)
