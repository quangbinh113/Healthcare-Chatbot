...
def _sorted_checkpoints(args: Config, checkpoint_prefix="checkpoint", use_mtime=False) -> List[str]:
...
def _rotate_checkpoints(args: Config, checkpoint_prefix="checkpoint", use_mtime=False) -> None:
